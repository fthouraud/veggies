...
describe('countNestedProperties', () => {
...
describe('assertObjectMatchSpec', () => {
    ...
    test('check object property does not contain value', () => {
        ...
        expect(() =>
            ...
            `Property 'last_name' (doet) contains 'doe': expected 'doet' to not include 'doe'`
        )
        expect(() =>
            assertObjectMatchSpec(
    ...
    test('check object property starts with value', () => {
        const objectToTest = { first_name: 'John', last_name: 'Doe' }

        expect(() =>
            assertObjectMatchSpec(objectToTest, [
                {
                    field: 'first_name',
                    matcher: 'starts with',
                    value: 'Jo',
        ...
        expect(() =>
            ...
            `Property 'first_name' (John) does not start with 'Ja': expected John to start with Ja`
        )
    })
    ...
    test('check object property does not start with value', () => {
        ...
        expect(() =>
            ...
            `Property 'first_name' (John) starts with 'Jo': expected John not to start with Jo`
        )
    ...
    test('check object property does not end with value', () => {
        ...
        ).toThrow(`Property 'first_name' (John) ends with 'hn': expected John not to end with hn`)
